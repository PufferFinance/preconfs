...
library BLS12381 {
    ...
    function flatten(G2Point memory point) internal pure returns (uint256[8] memory flattened) {
        flattened = [point.x[0], point.x[1], point.x_I[0], point.x_I[1], point.y[0], point.y[1], point.y_I[0], point.y_I[1]];
    }
}